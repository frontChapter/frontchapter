...
const PostSingle: React.FC<PostSingleProps> = ({ frontmatter, content, recentPosts }) => {
          ...
          <article>
            <div className="row justify-center">
              ...
              <div className="lg:col-8">
                {markdownify({ content: title, tag: "h1", className: "h2 mt-6" })}
              ...
              {recentPosts.slice(0, 2).map((post, index) => {
                ...
                return (
                  <div key={"post-" + index} className="animate mt-16 lg:col-5">
                    <Post post={post as unknown as PostType} i={index} />
                  </div>
                );
              })}
            </div>
