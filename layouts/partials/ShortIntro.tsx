...
const ShortIntro: React.FC<ShortIntroProps> = ({ intro }) => {
        ...
        <div className="relative px-4 py-[70px]">
          <div className="text-center">
            <div className="animate">
              <p>{intro.subtitle}</p>
                {markdownify({ content: intro.title, tag: "h2", className: "mt-4 section-title" })}
                {markdownify({ content: intro.description, tag: "p", className: "mt-10" })}
            </div>
