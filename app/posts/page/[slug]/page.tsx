...
const { blog_folder } = config.settings as { blog_folder: string; pagination: number };
...
const BlogPagination = async ({ params }: BlogPaginationParams): Promise<JSX.Element> => {
  ...
  const postIndex: ListPageType = await getListPage(`content/${blog_folder}/_index.md`);
