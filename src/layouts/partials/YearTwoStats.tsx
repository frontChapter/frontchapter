  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      const imageContainers =
        imagesRef.current?.querySelectorAll('.image-container');
          ...
          <div className="flex-1 md:w-1/2 text-right flex flex-col">
            ...
            <div className="mt-8">
              <Link
                ...
                className="px-8 py-4 bg-primary text-white font-semibold rounded-lg inline-block hover:opacity-90 transition-all hover:shadow-lg hover:shadow-primary/20"
              >
                {memories.link.label}
              </Link>
            </div>
